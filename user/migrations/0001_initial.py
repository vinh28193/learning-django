# Generated by Django 3.1.7 on 2023-11-11 15:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(error_messages={'unique': 'A user with that phone number already exists.'}, max_length=20, unique=True, verbose_name='phone number')),
                ...
                ('avatar_image', models.CharField(blank=True, max_length=255, null=True, verbose_name='avatar image')),
                ('language', models.CharField(default='en-us', max_length=5, verbose_name='language')),
